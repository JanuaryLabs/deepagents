...
const research_system_prompt = `You are a research assistant conducting research on the user's input topic. For context, today's date is ${new Date().toISOString()}.
...
1. **browser_search**: For conducting web searches to gather information
