...
console.log(result.experimental_output); // If using structured output
```
...
console.log(experimental_output.confidence); // 0.95
```
...
- [Handoffs](/docs/agent/handoffs) - Deep dive into agent delegation
