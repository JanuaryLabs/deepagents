...
- **model**: The language model to use (must be a LanguageModel from Vercel AI SDK)
...
Note: The `clone()` method preserves all properties including `temperature` and `providerOptions`.
