...
| Recipe | Use Case |
| --- | --- |
| [Agent as Tool](/docs/context/recipes/as-tool) | Delegate bounded sub-tasks to a specialist agent exposed as a tool |
| [Agent as Advisor](/docs/context/recipes/as-advisor) | Attach a stronger reviewer model for strategic guidance |
...
| [Error Recovery](/docs/context/recipes/error-recovery) | Intercepting API errors and triggering self-correction retries |
| [GCS Cloud Storage Volumes](/docs/context/recipes/gcs-cloud-storage) | Persist sandbox files to Google Cloud Storage from a remote daemon or same-host Linux mount |
...
- [Agent as Tool](/docs/context/recipes/as-tool) - Delegate sub-tasks to specialist agents
- [Agent as Advisor](/docs/context/recipes/as-advisor) - Strategic review from a stronger model
...
- [Error Recovery](/docs/context/recipes/error-recovery) - API error self-correction
