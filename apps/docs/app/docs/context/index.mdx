...
execution, Docker containers, Agent OS backends, and the shared bash tool
wrapper for agents.
...
| Sandbox Tooling             | `createBashTool()`, `createVirtualSandbox()`, `createContainerTool()`, and real command execution backends |
