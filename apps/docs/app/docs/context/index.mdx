...
execution, Docker containers, Agent OS backends, per-command file-change
tracking, and the shared bash tool wrapper for agents.
...
| Sandbox Tooling             | `createBashTool()`, `createVirtualSandbox()`, `createDockerSandbox()`, and real command execution backends |
...
- [Sandbox](/docs/context/sandbox) - Execute commands through virtual, Docker, or Agent OS backends
