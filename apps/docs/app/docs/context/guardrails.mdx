...
| `availableSkills` | `AvailableSkill[]` | Explicit model-facing skills available in context |
...
- [Error Recovery recipe](/docs/context/recipes/error-recovery) - Practical walkthrough of error recovery with guardrails
