...
The `save()` method persists pending messages to the graph with careful handling of updates.
...
public async save(): Promise<void> {
  ...
  // 1. Check for updates - rewind if needed
