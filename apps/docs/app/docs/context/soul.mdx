...
The soul protocol works alongside other fragments. A typical setup pairs it with `role()` for base instructions and an explicit `skills()` catalog:
...
const availableSkills: AvailableSkill[] = [
  {
    name: 'typescript',
    description: 'Apply project-specific TypeScript practices.',
    path: '/workspace/skills/typescript/SKILL.md',
  },
];
