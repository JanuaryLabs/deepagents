...
text2sql.instruct(
  ...
  term('PHI', 'Protected Health Information - any individually identifiable health data'),
  term('readmission', 'patient returning to hospital within 30 days of discharge'),
  ...
  term('ICD-10', 'International Classification of Diseases, 10th revision - diagnosis codes'),
  ...
  clarification({
    ...
    reason: 'Different readmission measures have different clinical significance',
  }),
  clarification({
  ...
  quirk({
    ...
    workaround: 'Check diagnosis_code_version column, use crosswalk table if needed',
  }),
  quirk({
  ...
  workflow({
    ...
    notes: 'CMS readmission measures have specific inclusion/exclusion criteria',
  }),
  workflow({
  ...
  example({
    ...
    sql: `SELECT DATE_TRUNC('week', arrival_datetime) as week,
            COUNT(*) as ed_visits,
