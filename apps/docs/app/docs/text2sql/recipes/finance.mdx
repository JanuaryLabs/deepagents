...
description: Pre-built fragment bundle for banking and financial databases
---

This recipe provides a reusable fragment bundle for financial databases covering loans, portfolios, transactions, and regulatory compliance.
...
Spread `...financeRecipe` into your `context(...fragments)` factory for
