...
description: Pre-built fragment bundle for e-commerce and retail databases
---

This recipe provides a reusable fragment bundle for e-commerce databases covering orders, customers, products, and revenue analytics.
...
Spread `...ecommerceRecipe` into your `context(...fragments)` factory for
