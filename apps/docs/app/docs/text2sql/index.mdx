...
| `createSqlCommand(text2Sql, options?: CreateSqlCommandOptions): CreateSqlCommandResult` | Wrap a `Text2Sql` instance as a just-bash command (`sql run`, `sql validate`, `sql index`) for virtual sandboxes |
