...
manually, see [SQL CLI in Sandboxes](/docs/text2sql/sqlv3).
...
| `sql index [adapter ...]`                              | Run adapter indexing inside a sandbox and write schema fragments plus progress events to files |
...
- [SQL CLI in Sandboxes](/docs/text2sql/sqlv3) - Install and configure the real `sql` command for chat flows
