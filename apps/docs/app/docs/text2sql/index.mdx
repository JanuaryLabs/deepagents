...
If you already own the bash sandbox and want to wire the `sql` command yourself,
see [Text2SqlV3 (Experimental)](/docs/text2sql/sqlv3).
...
- [Text2SqlV3 (Experimental)](/docs/text2sql/sqlv3) - Caller-owned sandbox setup
