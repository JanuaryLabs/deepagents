...
description: Current guidance for building schema-aware teaching bundles
---

The current public Text2SQL package does not export a `TeachingsGenerator` class
or a `text2sql.teach()` convenience method. If you want schema-aware teaching
bundles today, use one of the supported patterns below.

## Option 1: Build a Manual Teaching Bundle
...
workflow is manual teaching bundles plus synthesis-time `teachings` injection.
