...
Implementation (shared helper used by `.toPairs()`):
...
- [Teachings Generator](/docs/text2sql/teachings-generator) - Current guidance for building manual teaching bundles
...
const pairs = await producer.toPairs();
```
