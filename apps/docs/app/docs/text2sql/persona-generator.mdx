...
```typescript
import { PersonaGenerator } from '@deepagents/text2sql';
...
```typescript
import { PersonaGenerator, SchemaSynthesizer } from '@deepagents/text2sql';
...
```typescript
import { PersonaGenerator, BreadthEvolver } from '@deepagents/text2sql';
