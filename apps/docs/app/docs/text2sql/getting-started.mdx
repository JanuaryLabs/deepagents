...
1. **Adapter** - Connects to your data source (PostgreSQL, SQLite, SQL Server, MySQL/MariaDB, BigQuery, ClickHouse, or PostHog)
...
<Tabs groupId="database" items={['SQLite', 'PostgreSQL', 'SQL Server', 'MySQL/MariaDB', 'BigQuery', 'ClickHouse', 'PostHog']}>
<Tab value="SQLite">
```typescript
