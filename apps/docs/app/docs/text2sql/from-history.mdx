...
```typescript
import { FullContextExtractor, toPairs } from '@deepagents/text2sql';
...
```typescript
import { WindowedContextExtractor, toPairs } from '@deepagents/text2sql';
...
```typescript
import { SegmentedContextExtractor, toPairs } from '@deepagents/text2sql';
