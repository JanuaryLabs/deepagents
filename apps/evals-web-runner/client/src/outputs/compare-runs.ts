...
export type CompareRuns = {
  baseline: models.RunRow;
  candidate: models.RunRow;
  result: models.ComparisonResult;
};

export type CompareRuns400 =
  | {
...
export type CompareRuns404 = { message: 'One or both runs not found' };

export type CompareRuns415 =
  | {
      cause: {
